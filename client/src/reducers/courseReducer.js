  ...
  switch (action.type) {
    ...
    case types.CREATE_COURSE_SUCCESS:
      let result = _.assign({}, state, {
        list: [...state.list, _.assign({}, action.course)]
      });
    ...
    case types.UPDATE_COURSE_SUCCESS:
      return _.assign({}, state, {
        list: [...state.list.filter(course => course.id !== action.course.id), _.assign({}, action.course)]
      });

    case types.DELETE_COURSE_SUCCESS:
      return _.assign({}, state, {
        list: [...state.list.filter(course => course.id !== action.id)]
      });
