    ...
    return (
      <div>
        <Modal show={this.props.visible} onHide={this.props.close}>
          ...
          <Modal.Body>
            <StudentForm student={this.state.student} onChange={this.updateStudentState} errors={this.state.errors} />
          </Modal.Body>
          <Modal.Footer>
            <Button onClick={this.saveStudent}>{this.props.saving ? 'Saving...' : 'Save'}</Button>
