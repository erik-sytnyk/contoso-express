...
class InstructorSave extends React.Component<any, any> {
    constructor(props) {
        super(props);
    ...
    updateInstructorState(event) {
        ...
        if (_.isString(event)) {
            ...
            if (field === 'location') {
                ...
                let exist = _.find(courses, (item: any) => {
                   return item.id === id;
                });

                if (exist) {
                    instructor.courses = _.filter(courses, (course: any) => {
                       return course.id !== id;
                    });
                } else {
                    courses.push({id: id});
...
(InstructorSave as any).propTypes = {
