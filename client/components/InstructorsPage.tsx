...
class InstructorsPage extends React.Component<any, any> {
...
(InstructorsPage as any).propTypes = {
...
function mapDispatchToProps(dispatch) {
    return {
        actions: (bindActionCreators as any)(_.assign({}, instructorActions, enrollmentActions), dispatch)
    };
}
